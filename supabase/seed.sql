...
('Thai Jasmine Rice, 25 lb.', 'Member''s Mark', 'Grains & Starches', true, 18.98, 42, 0, 3, 180, 400, 50, 0.25, 'cup', 'volume', 'https://images.openfoodfacts.org/images/products/019/396/814/8096/front_en.3.400.jpg', 'Long grain jasmine rice', NULL, 'openfoodfacts', '0193968148096', '2025-01-15', 5, '2025-01-15 10:00:00'),
('100% Pure Olive Oil, 101 fl oz', 'Member''s Mark', 'Oils & Fats', true, 18.98, 0, 14, 0, 126, 202, 14, 1, 'tbsp', 'volume', NULL, 'Olive oil', NULL, 'manual', '1234567890124', '2025-01-14', 3, '2025-01-15 10:00:00'),
...
('Raw and Unfiltered Honey, 32 oz', 'Nature''s Nate Honey Co.', 'Condiments & Sauces', true, 13.98, 17, 0, 0, 68, 64, 21, 1, 'tbsp', 'volume', NULL, 'Raw unfiltered honey', NULL, 'manual', '1234567890126', '2025-01-12', 4, '2025-01-15 10:00:00'),
...
('Plain Nonfat Greek Yogurt, 40 oz', 'Member''s Mark', 'Dairy & Eggs', true, 4.28, 6.1, 0.66, 17.3, 98.74, 23, 170, 1, 'container', 'package', NULL, 'Nonfat Greek yogurt', NULL, 'manual', '1234567890136', '2025-01-11', 5, '2025-01-15 10:00:00'),
('Himalayan Pink Salt, Fine Ground, 16 oz', 'Member''s Mark', 'Seasonings & Spices', true, 7.00, 0, 0, 0, 0, 800, 5, 1, 'tsp', 'volume', NULL, 'Pink Himalayan salt', NULL, 'manual', '1234567890137', '2025-01-10', 2, '2025-01-15 10:00:00'),
('Black Pepper, Fine, 16 oz', 'Member''s Mark', 'Seasonings & Spices', true, 8.50, 1, 0, 0, 4, 400, 2, 1, 'tsp', 'volume', NULL, 'Ground black pepper', NULL, 'manual', '1234567890138', '2025-01-09', 3, '2025-01-15 10:00:00'),
('Garlic Powder, Fine, 16 oz', 'Member''s Mark', 'Seasonings & Spices', true, 8.00, 2.3, 0.02, 0.51, 11.5, 350, 3, 1, 'tsp', 'volume', NULL, 'Ground garlic', NULL, 'manual', '1234567890139', '2025-01-08', 4, '2025-01-15 10:00:00'),
('Organic Ground Ginger, 16 oz', 'Member''s Mark Organic', 'Seasonings & Spices', true, 8.50, 1.3, 0.1, 0.2, 6.5, 400, 2, 1, 'tsp', 'volume', NULL, 'Organic ground ginger', NULL, 'manual', '1234567890140', '2025-01-07', 2, '2025-01-15 10:00:00'),
('Organic Ground Turmeric, 16 oz', 'Member''s Mark Organic', 'Seasonings & Spices', true, 8.50, 1.43, 0.22, 0.17, 7.5, 400, 2, 1, 'tsp', 'volume', NULL, 'Organic ground turmeric', NULL, 'manual', '1234567890141', '2025-01-06', 3, '2025-01-15 10:00:00'),
...
('Organic Raw Unfiltered Apple Cider Vinegar, 32 fl oz', 'Bragg''s', 'Condiments & Sauces', true, 26.00, 0, 0, 0, 0, 64, 15, 1, 'tbsp', 'volume', NULL, 'Organic apple cider vinegar', NULL, 'manual', '1234567890156', '2024-12-21', 2, '2025-01-15 10:00:00'),
...
('Onion Powder, Ground, 16 oz', 'Member''s Mark', 'Seasonings & Spices', true, 8.00, 1.9, 0.02, 0.25, 8.7, 350, 2, 1, 'tsp', 'volume', NULL, 'Ground onion', NULL, 'manual', '1234567890162', '2024-12-15', 3, '2025-01-15 10:00:00'),
('Parsley Flakes, 16 oz', 'Member''s Mark', 'Seasonings & Spices', true, 7.00, 0.25, 0.03, 0.13, 1.8, 320, 1, 1, 'tsp', 'volume', NULL, 'Dried parsley', NULL, 'manual', '1234567890163', '2024-12-14', 2, '2025-01-15 10:00:00'),
('Cumin, Ground, 16 oz', 'Member''s Mark', 'Seasonings & Spices', true, 7.00, 0.93, 0.47, 0.37, 8.1, 350, 2, 1, 'tsp', 'volume', NULL, 'Ground cumin seeds', NULL, 'manual', '1234567890164', '2024-12-13', 4, '2025-01-15 10:00:00'),
('Beef Fajita Seasoning, 1 Oz', 'Siete', 'Seasonings & Spices', true, 2.99, 0, 0, 0, 0, 6, 5, 1, 'tsp', 'volume', 'https://img.thrivemarket.com/store/full/c/o/copy-of-810091781128_siete-1oz-beef-fajita-seasoning_front_1_1.jpg?w=1227&jpg_quality=90', 'Smoked Sea Salt, Garlic, Black Pepper, Onions, Paprika, Sea Salt, Hatch Red Chiles, Ground Dates.', NULL, 'manual', '1234567890165', '2024-12-12', 1, '2025-01-15 10:00:00'),
('Chicken Fajita Seasoning, 1 Oz', 'Siete', 'Seasonings & Spices', true, 2.99, 0, 0, 0, 0, 6, 5, 1, 'tsp', 'volume', 'https://www.instacart.com/assets/domains/product-image/file/large_509357c6-e962-4854-b779-0cd33a935350.png', 'Smoked sea salt, garlic, ground dates, onions, sea salt, black pepper, paprika, cumin, red bell peppers, chile flakes, green bell peppers, lime oil.', NULL, 'manual', '1234567890166', '2024-12-11', 2, '2025-01-15 10:00:00'),
...
('Ground Cinnamon, 16 oz', 'Member''s Mark', 'Seasonings & Spices', true, 7.99, 1.8, 0.1, 0.2, 8.5, 400, 2, 1, 'tsp', 'volume', NULL, 'Ground cinnamon', NULL, 'manual', '1234567890195', '2024-11-12', 1, '2025-01-15 10:00:00'),
