...
('100% Pure Olive Oil, 101 fl oz', 'Member''s Mark', 'Oils & Fats', true, 18.98, 0, 14, 0, 101, 14, 1, 'tbsp', 'volume', NULL, 'Olive oil', 4, 'manual', '1234567890124', '2025-01-14', 3, '2025-01-15 10:00:00'),
('Organic Virgin Coconut Oil, 56 oz', 'Member''s Mark Organic', 'Oils & Fats', true, 10.98, 0, 14, 0, 112, 14, 1, 'tbsp', 'volume', NULL, 'Organic pure virgin unrefined coconut oil', 5, 'manual', '1234567890125', '2025-01-13', 2, '2025-01-15 10:00:00'),
('Raw and Unfiltered Honey, 32 oz', 'Nature''s Nate Honey Co.', 'Condiments & Sauces', true, 13.98, 17, 0, 0, 50, 21, 1, 'tbsp', 'volume', NULL, 'Raw unfiltered honey', 5, 'manual', '1234567890126', '2025-01-12', 4, '2025-01-15 10:00:00'),
('Organic 100% Pure Maple Syrup, 32 oz', 'Member''s Mark Organic', 'Condiments & Sauces', true, 11.98, 13, 0, 0, 64, 20, 1, 'tbsp', 'volume', NULL, 'Organic maple syrup', 4, 'manual', '1234567890127', '2025-01-11', 3, '2025-01-15 10:00:00'),
('Boneless and Skinless Chicken Breasts, 3 lb', 'Member''s Mark', 'Proteins', true, 21.11, 0, 3.6, 31, 8, 113, 1, 'piece', 'package', NULL, 'Boneless skinless chicken breasts', 5, 'manual', '1234567890128', '2025-01-14', 6, '2025-01-15 10:00:00'),
('Organic Pasture Raised Eggs, 12 ct', 'Member''s Mark Organic', 'Dairy & Eggs', true, 7.00, 0.6, 5.4, 7.5, 12, 68, 1, 'piece', 'package', NULL, 'Pasture-raised eggs', 5, 'manual', '1234567890129', '2025-01-13', 8, '2025-01-15 10:00:00'),
('Skinless and Boneless Atlantic Salmon Fillet, 2.5 lb', 'Member''s Mark', 'Proteins', true, 23.94, 0, 5.4, 17, 8, 85, 1, 'piece', 'package', NULL, 'Atlantic salmon fillet', 5, 'manual', '1234567890130', '2025-01-12', 4, '2025-01-15 10:00:00'),
('85/15 Organic Grass Fed Ground Beef, 2 lb', 'Member''s Mark', 'Proteins', true, 17.94, 0, 15, 21, 8, 113, 100, 'g', 'weight', NULL, 'Ground beef (85% lean, 15% fat)', 5, 'manual', '1234567890131', '2025-01-14', 7, '2025-01-15 10:00:00'),
('Grated Parmigiano Reggiano, 8 oz', 'Kroger', 'Dairy & Eggs', true, 4.99, 4, 28.6, 38.4, 50, 100, 28, 'g', 'weight', NULL, 'Parmigiano Reggiano cheese', 5, 'manual', '1234567890132', '2025-01-13', 5, '2025-01-15 10:00:00'),
('Avocados, 5 ct', 'Member''s Mark', 'Fruits', true, 4.48, 8.5, 14.7, 2, 5, 100, 1, 'piece', 'package', NULL, 'Avocados', 5, 'manual', '1234567890133', '2025-01-14', 6, '2025-01-15 10:00:00'),
('Bananas, 3 lb', 'Chiquita / Member''s Mark Organic', 'Fruits', true, 1.97, 22.8, 0.3, 1.1, 12, 118, 1, 'piece', 'package', NULL, 'Bananas', 4, 'manual', '1234567890134', '2025-01-13', 9, '2025-01-15 10:00:00'),
('Simple Truth Organic Shredded Romaine Lettuce, 8 oz', 'Simple Truth', 'Vegetables', true, 2.79, 1.5, 0.1, 0.5, 4, 72, 1, 'cup', 'volume', NULL, 'Organic romaine lettuce', 4, 'manual', '1234567890135', '2025-01-12', 4, '2025-01-15 10:00:00'),
('Plain Nonfat Greek Yogurt, 40 oz', 'Member''s Mark', 'Dairy & Eggs', true, 4.28, 6.1, 0.66, 17.3, 1, 170, 1, 'container', 'package', NULL, 'Nonfat Greek yogurt', 4, 'manual', '1234567890136', '2025-01-11', 5, '2025-01-15 10:00:00'),
('Himalayan Pink Salt, Fine Ground, 16 oz', 'Member''s Mark', 'Seasonings & Spices', true, 7.00, 0, 0, 0, 200, 5, 1, 'tsp', 'volume', NULL, 'Pink Himalayan salt', 5, 'manual', '1234567890137', '2025-01-10', 2, '2025-01-15 10:00:00'),
('Black Pepper, Fine, 16 oz', 'Member''s Mark', 'Seasonings & Spices', true, 8.50, 1, 0, 0, 200, 2, 1, 'tsp', 'volume', NULL, 'Ground black pepper', 4, 'manual', '1234567890138', '2025-01-09', 3, '2025-01-15 10:00:00'),
('Garlic Powder, Fine, 16 oz', 'Member''s Mark', 'Seasonings & Spices', true, 8.00, 2.3, 0.02, 0.51, 200, 3, 1, 'tsp', 'volume', NULL, 'Ground garlic', 4, 'manual', '1234567890139', '2025-01-08', 4, '2025-01-15 10:00:00'),
('Organic Ground Ginger, 16 oz', 'Member''s Mark Organic', 'Seasonings & Spices', true, 8.50, 1.3, 0.1, 0.2, 200, 2, 1, 'tsp', 'volume', NULL, 'Organic ground ginger', 4, 'manual', '1234567890140', '2025-01-07', 2, '2025-01-15 10:00:00'),
('Organic Ground Turmeric, 16 oz', 'Member''s Mark Organic', 'Seasonings & Spices', true, 8.50, 1.43, 0.22, 0.17, 200, 2, 1, 'tsp', 'volume', NULL, 'Organic ground turmeric', 4, 'manual', '1234567890141', '2025-01-06', 3, '2025-01-15 10:00:00'),
('Multi Bell Sweet Peppers, 6 ct', 'Member''s Mark', 'Vegetables', true, 6.72, 9, 0.5, 1.5, 6, 149, 1, 'cup', 'volume', NULL, 'Bell peppers', 4, 'manual', '1234567890142', '2025-01-05', 4, '2025-01-15 10:00:00'),
('Taylor Farms Brussels Sprouts, 2 lb', 'Taylor Farms', 'Vegetables', true, 4.18, 11, 0.8, 4, 8, 156, 1, 'cup', 'volume', NULL, 'Brussels sprouts', 4, 'manual', '1234567890143', '2025-01-04', 3, '2025-01-15 10:00:00'),
('Anjou Pears, 5 lb', 'Member''s Mark', 'Fruits', true, 8.44, 27, 0.3, 0.6, 10, 178, 1, 'piece', 'package', NULL, 'Pears', 4, 'manual', '1234567890144', '2025-01-03', 5, '2025-01-15 10:00:00'),
('Green Seedless Grapes, 3 lb', 'Member''s Mark', 'Fruits', true, 5.97, 16, 0.3, 0.6, 6, 92, 1, 'cup', 'volume', NULL, 'Green seedless grapes', 4, 'manual', '1234567890145', '2025-01-02', 6, '2025-01-15 10:00:00'),
('Mangos, 8.8 lb', 'Member''s Mark', 'Fruits', true, 8.18, 25, 0.6, 1.4, 8, 165, 1, 'cup', 'volume', NULL, 'Mangoes', 5, 'manual', '1234567890146', '2025-01-01', 4, '2025-01-15 10:00:00'),
('Bone-In Chicken Drumsticks, 2 lb', 'Member''s Mark', 'Proteins', true, 5.75, 0, 5.7, 24.2, 8, 100, 3.5, 'oz', 'weight', NULL, 'Chicken drumsticks (skinless, boneless)', 4, 'manual', '1234567890147', '2024-12-30', 5, '2025-01-15 10:00:00'),
('Bone-In Chicken Thighs, 2 lb', 'Member''s Mark', 'Proteins', true, 8.13, 0, 8.2, 24.8, 8, 100, 3.5, 'oz', 'weight', NULL, 'Chicken thighs (skinless, boneless)', 4, 'manual', '1234567890148', '2024-12-29', 4, '2025-01-15 10:00:00'),
('Grass Fed Beef Ribeye Steak, 1.5 lb', 'Member''s Mark', 'Proteins', true, 19.17, 0, 10.8, 23.8, 4, 85, 3, 'oz', 'weight', NULL, 'Ribeye steak', 5, 'manual', '1234567890149', '2024-12-28', 3, '2025-01-15 10:00:00'),
('Prime Beef Strip Steak, 1.5 lb', 'Member''s Mark', 'Proteins', true, 24.67, 0, 7.6, 26, 4, 85, 3, 'oz', 'weight', NULL, 'Prime beef strip steak', 5, 'manual', '1234567890150', '2024-12-27', 2, '2025-01-15 10:00:00'),
('USDA Choice Angus Beef NY Strip Steak, 2 lb', 'Member''s Mark', 'Proteins', true, 49.38, 0, 7.6, 26, 4, 85, 3, 'oz', 'weight', NULL, 'USDA Choice Angus beef NY strip', 5, 'manual', '1234567890151', '2024-12-26', 1, '2025-01-15 10:00:00'),
('Vital Proteins Collagen Peptides Powder, 1.5 lb', 'Vital Proteins', 'Proteins', true, 29.98, 0, 0, 18, 30, 20, 2, 'scoop', 'volume', NULL, 'Hydrolyzed bovine collagen peptides', 5, 'manual', '1234567890152', '2024-12-25', 3, '2025-01-15 10:00:00'),
('Arm & Hammer Baking Soda, 13.5 lb', 'Arm & Hammer', 'Baking Supplies', true, 27.89, 0, 0, 0, 1000, 5, 1, 'tsp', 'volume', NULL, 'Sodium bicarbonate', 5, 'manual', '1234567890153', '2024-12-24', 1, '2025-01-15 10:00:00'),
('Coconut Water, 12 fl oz, 12 pk', 'Vita Coco', 'Beverages', true, 19.98, 10.4, 0, 0.5, 12, 245, 1, 'cup', 'volume', NULL, 'Coconut water', 4, 'manual', '1234567890154', '2024-12-23', 8, '2025-01-15 10:00:00'),
('Member''s Mark Purified Water, 16.9 fl oz, 40 pk', 'Member''s Mark', 'Beverages', true, 3.98, 0, 0, 0, 40, 500, 1, 'bottle', 'package', NULL, 'Purified water', 4, 'manual', '1234567890155', '2024-12-22', 12, '2025-01-15 10:00:00'),
('Organic Raw Unfiltered Apple Cider Vinegar, 32 fl oz', 'Bragg''s', 'Condiments & Sauces', true, 26.00, 0, 0, 0, 100, 15, 1, 'tbsp', 'volume', NULL, 'Organic apple cider vinegar', 5, 'manual', '1234567890156', '2024-12-21', 2, '2025-01-15 10:00:00'),
...
('Daisy Brand Pure and Natural Sour Cream, 14 oz, 2 pk', 'Daisy Brand', 'Dairy & Eggs', true, 4.88, 1, 5, 1, 28, 30, 2, 'tbsp', 'volume', NULL, 'Cultured cream', 4, 'manual', '1234567890158', '2024-12-19', 4, '2025-01-15 10:00:00'),
('Gold Kiwi, 2 lb', 'Member''s Mark', 'Fruits', true, 7.97, 10.1, 0.4, 0.8, 8, 75, 1, 'piece', 'package', NULL, 'Kiwifruit', 5, 'manual', '1234567890159', '2024-12-18', 5, '2025-01-15 10:00:00'),
('Green Kiwi, 3 lb', 'Member''s Mark', 'Fruits', true, 8.47, 10.1, 0.4, 0.8, 12, 75, 1, 'piece', 'package', NULL, 'Kiwifruit', 4, 'manual', '1234567890160', '2024-12-17', 4, '2025-01-15 10:00:00'),
('Clementine Mandarins, 5 lb', 'Member''s Mark', 'Fruits', true, 7.62, 9, 0, 1, 15, 74, 1, 'piece', 'package', NULL, 'Clementines', 4, 'manual', '1234567890161', '2024-12-16', 7, '2025-01-15 10:00:00'),
('Onion Powder, Ground, 16 oz', 'Member''s Mark', 'Seasonings & Spices', true, 8.00, 1.9, 0.02, 0.25, 200, 2, 1, 'tsp', 'volume', NULL, 'Ground onion', 4, 'manual', '1234567890162', '2024-12-15', 3, '2025-01-15 10:00:00'),
('Parsley Flakes, 16 oz', 'Member''s Mark', 'Seasonings & Spices', true, 7.00, 0.25, 0.03, 0.13, 200, 1, 1, 'tsp', 'volume', NULL, 'Dried parsley', 4, 'manual', '1234567890163', '2024-12-14', 2, '2025-01-15 10:00:00'),
('Cumin, Ground, 16 oz', 'Member''s Mark', 'Seasonings & Spices', true, 7.00, 0.93, 0.47, 0.37, 200, 2, 1, 'tsp', 'volume', NULL, 'Ground cumin seeds', 4, 'manual', '1234567890164', '2024-12-13', 4, '2025-01-15 10:00:00'),
...
('Fresh Cucumber, 1 lb', 'Member''s Mark', 'Vegetables', true, 1.99, 3.6, 0.1, 0.7, 4, 100, 1, 'piece', 'package', NULL, 'Fresh cucumber', 4, 'manual', '1234567890183', '2024-11-24', 3, '2025-01-15 10:00:00'),
('Fresh Lemon Juice, 32 fl oz', 'Member''s Mark', 'Condiments & Sauces', true, 4.98, 2.5, 0, 0.2, 64, 15, 1, 'tbsp', 'volume', NULL, 'Fresh lemon juice', 4, 'manual', '1234567890184', '2024-11-23', 2, '2025-01-15 10:00:00'),
('Fresh Dill, 1 oz', 'Member''s Mark', 'Vegetables', true, 2.49, 1.1, 0.1, 0.4, 8, 3.5, 1, 'tbsp', 'volume', NULL, 'Fresh dill', 4, 'manual', '1234567890185', '2024-11-22', 1, '2025-01-15 10:00:00'),
('Coconut Aminos, 16 fl oz', 'Coconut Secret', 'Condiments & Sauces', true, 8.99, 0, 0, 0, 32, 15, 1, 'tbsp', 'volume', NULL, 'Coconut aminos', 4, 'manual', '1234567890186', '2024-11-21', 2, '2025-01-15 10:00:00'),
('Red Pepper Flakes, 2 oz', 'Member''s Mark', 'Seasonings & Spices', true, 3.99, 0, 0, 0, 100, 2, 1, 'tsp', 'volume', NULL, 'Red pepper flakes', 4, 'manual', '1234567890187', '2024-11-20', 1, '2025-01-15 10:00:00'),
('Fresh Cauliflower, 1 head', 'Member''s Mark', 'Vegetables', true, 3.99, 5.3, 0.3, 2.0, 6, 100, 1, 'cup', 'volume', NULL, 'Fresh cauliflower', 4, 'manual', '1234567890188', '2024-11-19', 2, '2025-01-15 10:00:00'),
('Fresh Pineapple, 1 piece', 'Member''s Mark', 'Fruits', true, 4.99, 22.0, 0.1, 0.9, 8, 100, 1, 'cup', 'volume', NULL, 'Fresh pineapple', 4, 'manual', '1234567890189', '2024-11-18', 1, '2025-01-15 10:00:00'),
('Fresh Red Bell Pepper, 1 piece', 'Member''s Mark', 'Vegetables', true, 1.49, 6.0, 0.3, 1.0, 1, 100, 1, 'piece', 'package', NULL, 'Fresh red bell pepper', 4, 'manual', '1234567890190', '2024-11-17', 2, '2025-01-15 10:00:00'),
('Fresh Green Onions, 1 bunch', 'Member''s Mark', 'Vegetables', true, 1.99, 1.8, 0.1, 0.5, 8, 15, 1, 'tbsp', 'volume', NULL, 'Fresh green onions', 4, 'manual', '1234567890191', '2024-11-16', 1, '2025-01-15 10:00:00'),
('Raw Cashews, 16 oz', 'Member''s Mark', 'Snacks', true, 8.99, 8.6, 12.4, 5.2, 16, 28, 0.25, 'cup', 'volume', NULL, 'Raw cashews', 4, 'manual', '1234567890192', '2024-11-15', 2, '2025-01-15 10:00:00'),
('Almond Flour, 16 oz', 'Member''s Mark', 'Baking Supplies', true, 12.99, 6.0, 14.0, 6.0, 32, 28, 0.25, 'cup', 'volume', NULL, 'Almond flour', 4, 'manual', '1234567890193', '2024-11-14', 1, '2025-01-15 10:00:00'),
('Vanilla Protein Powder, 1 lb', 'Member''s Mark', 'Proteins', true, 24.99, 3.0, 1.5, 24.0, 30, 30, 1, 'scoop', 'volume', NULL, 'Vanilla protein powder', 4, 'manual', '1234567890194', '2024-11-13', 2, '2025-01-15 10:00:00'),
('Ground Cinnamon, 16 oz', 'Member''s Mark', 'Seasonings & Spices', true, 7.99, 1.8, 0.1, 0.2, 200, 2, 1, 'tsp', 'volume', NULL, 'Ground cinnamon', 4, 'manual', '1234567890195', '2024-11-12', 1, '2025-01-15 10:00:00'),
('Pure Vanilla Extract, 8 fl oz', 'Member''s Mark', 'Baking Supplies', true, 9.99, 0, 0, 0, 96, 5, 1, 'tsp', 'volume', NULL, 'Pure vanilla extract', 4, 'manual', '1234567890196', '2024-11-11', 2, '2025-01-15 10:00:00');
